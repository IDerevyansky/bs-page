    ...
    return(
        ...
        <div className={content.bg == 'true' ? "bgBox color" : "bgBox"}>
            ...
            <div className='contentBox'>
                ...
                <h2>Меня зовут <span className='font-semibold'>Наталья Деревянская</span>, я магистр психологии, кинезиолог, нейрокинезиолог и психотерапевтический кинезиолог.</h2> 
